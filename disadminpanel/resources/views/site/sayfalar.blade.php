...
@section('icerikalani')
    ...
    <!-- Start Hero Section -->
    <section class="cs_page_header cs_bg_filed cs_primary_bg" data-src="/site/assets/images/about_header_bg.jpg">
      <div class="container">
        ...
        <div class="row align-items-center cs_gap_y_40 cs_mobile_reverse">
          <div class="col-lg-6">
            <div class="cs_section_heading cs_style_1">
              <h3 class="cs_section_title_up cs_ternary_font cs_accent_color cs_normal cs_fs_24">Hakkımızda</h3>
              <h2 class="cs_section_title cs_semibold cs_fs_56 mb-0">{{ $sayfa->sayfa_adi }} </h2>
            </div>
            <div class="cs_about_text">
              <p> {{ Str::limit($sayfa->detay_icerigi, 100) }}</p>
            </div>
            <ul class="cs_list cs_style_1 cs_mp0 cs_fs_18">
                @foreach ($sayfalar as $sayfa )
                @if($sayfa->id == $lastRecord2->id)
            ...
            <a href="#" class="cs_btn cs_style_1 cs_fs_18 cs_medium">Devamını oku
          ...
          <div class="col-lg-5 offset-lg-1">
            <img src="/site/assets/images/camii.webp" alt="">
          </div>
        </div>
      </div>
      <div class="cs_height_140 cs_height_lg_80"></div>
        ...
        <div class="container">
          <div class="cs_section_heading cs_style_1 text-center">
            <h3 class="cs_section_title_up cs_ternary_font cs_accent_color cs_normal cs_fs_24">
                Neden Bİzİ Seçmelİsİnİz?</h3>
            <h2 class="cs_section_title cs_semibold cs_fs_56 mb-0">
                En İyi Seyahat Deneyimini Yaşayın</h2>
          </div>
          ...
          <div class="cs_iconbox_4_wrap">
                ...
                <div class="col-lg-12 col-6">
                  <div class="cs_iconbox cs_style_4">
                    <div class="cs_iconbox_icon cs_center">
                      <img src="/site/assets/images/icons/calendar_icon_2.svg" alt="Calendar Icon">
                    </div>
                    <h2 class="cs_iconbox_title cs_fs_24 cs_semibold">
                        Seyahat Planını Belirleyin</h2>
                    <p class="cs_iconbox_subtitle mb-0">Kendi seyahat planınızı oluşturun, tercih ettiğiniz varış noktalarını ve etkinliklerinizi kolayca seçin.</p>
                  </div>
                </div>
                <div class="col-lg-12 col-6">
                  <div class="cs_iconbox cs_style_4">
                    <div class="cs_iconbox_icon cs_center">
                      <img src="/site/assets/images/icons/hotel-icon.svg" alt="Hotel Icon">
                    </div>
                    <h2 class="cs_iconbox_title cs_fs_24 cs_semibold">
                        Dost canlısı çalışanlar</h2>
                    <p class="cs_iconbox_subtitle mb-0">
                        Müşteri odaklı ekibimiz her türlü ihtiyaç veya sorunuza yardımcı olmaktan her zaman mutluluk duyacaktır.</p>
                  </div>
                </div>
              </div>
            </div>
            <div>
              <div class="cs_iconbox_4_thumb cs_center">
                <img src="/site/assets/images/about_4.png" alt="About Thumb">
              </div>
            </div>
            <div>
              <div class="row cs_gap_y_45">
                <div class="col-lg-12 col-6">
                  <div class="cs_iconbox cs_style_4">
                    <div class="cs_iconbox_icon cs_center">
                      <img src="/site/assets/images/icons/compass_icon.svg" alt="Calendar Icon">
                    </div>
                    <h2 class="cs_iconbox_title cs_fs_24 cs_semibold">
                        Etrafı Keşfedin</h2>
                    <p class="cs_iconbox_subtitle mb-0">
                        Çevrenizdeki ilgi çekici noktaları keşfedin ve seyahatinizin her anından en iyi şekilde yararlanın.
                        </p>
                  </div>
                </div>
                <div class="col-lg-12 col-6">
                  <div class="cs_iconbox cs_style_4">
                    <div class="cs_iconbox_icon cs_center">
                      <img src="/site/assets/images/icons/headset_icon.svg" alt="Hotel Icon">
                    </div>
                    <h2 class="cs_iconbox_title cs_fs_24 cs_semibold">
                        7/24 Destek</h2>
                    <p class="cs_iconbox_subtitle mb-0">
                        7/24 sizin için buradayız! Destek ekibimiz yolculuğunuz boyunca her an size yardımcı olmaya hazırdır.
                        </p>
                  </div>
                </div>
              </div>
    ...
    <!-- Start Team Section -->
     <section class="cs_accent_bg_1">
       ...
       <div class="container">
         <div class="cs_section_heading cs_style_1 text-center">
           <h3 class="cs_section_title_up cs_ternary_font cs_accent_color cs_normal cs_fs_24">Seyahat Acenteleri</h3>
           <h2 class="cs_section_title cs_semibold cs_fs_56 mb-0">
            Ekip Üyeleri</h2>
         </div>
         <div class="cs_height_55 cs_height_lg_40"></div>
         ...
         <div class="row cs_gap_y_24">
           <div class="col-lg-4">
             <div class="cs_team cs_style_1 position-relative">
               <div class="cs_team_thumb cs_zoom overflow-hidden">
                 <img src="/site/assets/images/seyma.webp" class="cs_zoom_in">
               </div>
               <div class="cs_team_info text-center position-absolute">
                 <h2 class="cs_team_title cs_fs_24 cs_medium cs_white_color">Şeymanur AKBULUT</h2>
                 <p class="cs_team_subtitle cs_white_color">
                    KURUCU ORTAK</p>
           ...
           <div class="col-lg-4">
             <div class="cs_team cs_style_1 position-relative">
               <div class="cs_team_thumb cs_zoom overflow-hidden">
                 <img src="/site/assets/images/kaan.webp" alt="Team Thumb" class="cs_zoom_in">
               </div>
               <div class="cs_team_info text-center position-absolute">
                 <h2 class="cs_team_title cs_fs_24 cs_medium cs_white_color">Serhan Kaan CANKURT</h2>
                 <p class="cs_team_subtitle cs_white_color">
                    KURUCU ORTAK</p>
                 <div class="cs_social_btns">
                   <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
           ...
           <div class="col-lg-4">
             <div class="cs_team cs_style_1 position-relative">
               <div class="cs_team_thumb cs_zoom overflow-hidden">
                 <img src="/site/assets/images/sıla.webp" alt="Team Thumb" class="cs_zoom_in">
               </div>
               <div class="cs_team_info text-center position-absolute">
                 <h2 class="cs_team_title cs_fs_24 cs_medium cs_white_color">Esma Sıla ŞAHİNCİ</h2>
                 <p class="cs_team_subtitle cs_white_color">
                    KURUCU ORTAK</p>
                 <div class="cs_social_btns">
                   <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
    ...
    <section>
      <div class="cs_height_140 cs_height_lg_80"></div>
      <div class="container">
        <div class="cs_video_block cs_style_1 cs_bg_filed position-relative" data-src="/site/assets/images/videobg1.jpg">
          <a href="https://www.youtube.com/embed/UQAReYr9wko?si=yoIlmIRDV2DOw4EH" class="cs_player_btn cs_center cs_accent_bg cs_video_open">
          ...
          <h2 class="cs_video_title cs_fs_60 cs_semibold cs_white_color position-absolute mb-0">
            Yolculuğumuz <br>
            Videolarda</h2>
          <span class="cs_location cs_fs_20 cs_white_color">
            <i class="fa-solid fa-location-dot"></i>
            Lokasyon Pamukkale Travertenleri, Türkiye
          </span>
        </div>
      </div>
    </section>
